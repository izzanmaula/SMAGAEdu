...
if($jenis_soal == 'pilihan_ganda') {
    ...
    Buatkan 1 soal pilihan ganda yang sesuai dengan:
    - Mata pelajaran: $mata_pelajaran
    - Tingkat kelas: $tingkat
    - Mengacu pada kurikulum pendidikan Indonesia
    - Memiliki tingkat kesulitan yang sesuai
    - Pastikan setiap pilihan jawaban masuk akal
    - Hindari penggunaan 'semua benar' atau 'semua salah' pada pilihan jawaban
