...
<body class="bg-light">
                ...
                <div class="card border rounded-4 sticky-top" style="top: 20px;">
                    ...
                    <div class="p-4 flex-grow-1 overflow-auto" id="analisisContent">
                        <div id="konfirmasiAnalisis" class="text-center py-5 px-2">
                            <div class="mb-4">
                                <i class="bi bi-person-fill-check" style="font-size: 3rem; color: rgb(218, 119, 86);"></i>
                            </div>
                            ...
                            <div class="border rounded-4 p-3 mb-4 bg-light d-flex align-items-center">
                                ...
                                <p style="font-size: 12px;" class="p-0 m-0 text-start">Untuk hasil analisis sempurna, pastikan ujian telah selesai dilaksanakan</p>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            pertanyaan: '" . addslashes($jawaban['pertanyaan']) . "',
            jawaban_a: '" . addslashes($jawaban['jawaban_a']) . "',
            jawaban_b: '" . addslashes($jawaban['jawaban_b']) . "',
            jawaban_c: '" . addslashes($jawaban['jawaban_c']) . "',
            jawaban_d: '" . addslashes($jawaban['jawaban_d']) . "',
