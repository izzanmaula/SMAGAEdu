...
<body>
    ...
    <div class="col p-4 col-utama mt-1 mt-md-0">
        ...
        <!-- Header Section -->
        <div class="mb-4">
            <h3 class="fw-bold m-0">Halo, Kepala Sekolah</h3>
        </div>
        <p></p>
        ...
        <div class="row mb-4">
            ...
            <div class="card shadow-none border h-100" style="border-radius: 15px; overflow: hidden; position: relative;">
                <div class="card-body">
                <h5 class="card-title">Total Kelas Aktif</h5>
                <?php
                ...
                ?>
                <h2 class="display-4 mt-3 fw-bold"><?php echo $count_kelas; ?></h2>
                <i class="bi bi-book-fill position-absolute opacity-25" 
            ...
            <div class="card shadow-none border h-100" style="border-radius: 15px; overflow: hidden; position: relative;">
                ...
                ?>
                <h2 class="display-4 mt-3 fw-bold"><?php echo $count_guru; ?></h2>
                <i class="bi bi-person-badge-fill position-absolute opacity-25" 
                   style="bottom: -85px; right: -15px; font-size: 150px; color:rgb(218, 119, 86);"></i>
                </div>
            </div>
            </div>
            ...
            <div class="card shadow-none border h-100" style="border-radius: 15px; overflow: hidden; position: relative;">
                ...
                ?>
                <h2 class="display-4 mt-3 fw-bold"><?php echo $count_siswa; ?></h2>
