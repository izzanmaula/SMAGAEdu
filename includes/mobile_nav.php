...
$nav_items = $is_guru ? [
   ['url' => 'beranda_guru.php', 'icon' => 'house', 'text' => ''],
   ['url' => 'ujian_guru.php', 'icon' => 'clipboard', 'text' => ''], 
   ['url' => 'raport_pg.php', 'icon' => 'journal-text', 'text' => ''],
   ['url' => 'ai_guru.php', 'icon' => 'stars', 'text' => ''],
   ['url' => '#', 'icon' => 'gear', 'text' => '', 'is_menu' => true, 'modal' => '#pengaturanModal']
] : [
