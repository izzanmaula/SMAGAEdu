    ...
    <div class="mt-auto position-absolute bottom-0 start-0 p-3 w-100">
        <div class="dropdown">
            <button class="btn d-flex align-items-center gap-2 w-100 rounded-3 border bg-white" type="button" data-bs-toggle="dropdown">
                ...
                <span class="text-truncate" style="font-size: 13px;"><?php echo $guru['namaLengkap']; ?></span>
            </button>
            <ul class="dropdown-menu dropdown-menu-start w-100 shadow-sm animate slideIn">
                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal_pengaturan">
